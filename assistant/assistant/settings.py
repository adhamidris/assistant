"""
Django settings for AI Personal Business Assistant project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-op=)o^o+t3t#$ev!zux=nl%@p@3e$-ig5rgr+x1x+)%!w+c#@a')
...
MIDDLEWARE = [
    # 'core.security.SecurityMiddleware',  # Temporarily disabled due to magic library issue
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='assistant_db'),
        'USER': config('DB_USER', default='postgres'),
        'PASSWORD': config('DB_PASSWORD', default='adham123'),
...
AWS_STORAGE_BUCKET_NAME = config('S3_BUCKET_NAME', default='assistant-files')
AWS_S3_ENDPOINT_URL = config('S3_ENDPOINT_URL', default='http://localhost:9000')
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@yourbusiness.com')
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'assistant.log',
            'formatter': 'verbose',
        },
        'security_file': {
            'level': 'WARNING',
